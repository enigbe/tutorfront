...
pub async fn handle_register(
    ...
    if user_not_found {
        if params.password != params.confirmation {
            ctx.insert("error", "Passwords do no match");
            ...
            s = format!("Congratulations. You have been successfully registered with TutorFront and your tutor id is: {}. To start using TutorFront, please login with your credentials.",tutor_response.tutor_id);
